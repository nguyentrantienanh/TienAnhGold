...
namespace TienAnhGold.Migrations
{
    ...
    [Migration("20250325150451_AddHasAdminJoinedMessageToChat")]
    partial class AddHasAdminJoinedMessageToChat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TienAnhGold.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Admin Master",
                            Password = "$2a$11$FzLC5o/FSZmo1Zc.i5Xny.oKyeCCerRnz2FSrd4gMUgjunkhlE5.i",
                            Role = "Admin"
                        });
                });
